...
public class FriendOfUser implements RelationshipType, Serializable
{
    ...
    public boolean equals( Object obj )
    {
        ...
        return new EqualsBuilder().append( this.id, rhs.id ).append( this.user, rhs.user )
                .append( this.friend, rhs.friend ).isEquals();
    }

    @Override
    public int hashCode()
    {
        return new HashCodeBuilder().append( id ).append( user ).append( friend ).toHashCode();
    }
    ...
    {
        return new ToStringBuilder( this ).append( "id", id ).append( "user", user ).append( "friend", friend )
                .toString();
    }
